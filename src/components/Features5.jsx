          ...
          <div className="w-full lg:w-1/2 mb-12 lg:mb-0">
            <div className="mx-auto lg:mx-auto w-11/12 sm:w-4/5 md:w-3/4 lg:w-unset">
              ...
              <p className="mb-10 text-customGrayText leading-loose">
                A distinctive feature of Pytest-BDD-Report is its ability to represent scenarios in an original manner, without overlooking any important information. The presentation of outcomes for individual steps, along with any error messages, allows users to fully grasp the execution flow of the test scenario and quickly identify the issue.
              </p>
